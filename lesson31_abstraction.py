...
#     def turn_on(self):
#         print("Холодильник включается: запускается компрессор и лампочка загорается")
#
#
# class Microwave(Appliance):
#     def turn_on(self):
#         print("Микроволновка включается: дисплей загорается и готова к установке времени")
#
# fridge = Fridge()
# microwave = Microwave()
# fridge.turn_on()
...
#     def work(self):
#         print("Creates layouts and designs interfaces")
#
# developer = Developer()
# designer = Designer()
# developer.work()
