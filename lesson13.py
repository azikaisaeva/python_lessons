...
# numbers = [i for i in range(1, 50) if i % 2 == 0]
# print(numbers)

# 3. Создайте список чисел от 1 до 50, заменяя все числа, кратные 3, на 'Fizz'.
# list = ["Fizz" if i % 3 == 0 else i for i in range(1, 50)]
# print(list)
