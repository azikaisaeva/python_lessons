...
#         rounded_number = round(fahrenheit, 2)
#         print(f"{num}C = {rounded_number}F")
#     elif unit == "F":
#         celsius = (num - 32) * 5 / 9
#         rounded_result = round(celsius, 2)
#         print(f"{num}F = {rounded_result}C")
#     else:
#         print("Укажите температура в С или F")
#
# temp_converter()
...
# def simple_calculator():
    ...
    #     result = num1 / num2
    # else:
    #     print("Ошибка. Неподдерживаемая функция")
    #     return
...
#         if char in vowels:
#             count += 1
#     print(f"Quantity of vowels: {count}")
# count_vowels()
...
#     print("Your reversed text:", reversed_text)
#
#
# reverse_string()
...
def char_frequency():
    ...
    for char in get_string:
        if char in text:
            ...
            text[char] = 1
    print("Чистота символов", get_string)
char_frequency()
