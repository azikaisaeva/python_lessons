...
#
#     def introduce(self):
#         return f"Hello, my name is {self.name} a student with ID {self.student_id}"
#
#
# student = Student("Aziza", 27, 98754)
...
#
#     def move(self):
#         return f"Car is moving at {self.speed} km/h using {self.fuel_type} fuel"
#
#
# car = Car()
