...
# Ваш код здесь
print("Learning Python is fun".find("Python"))
print("Learning Python is fun".replace("fun", "awesome"))
...
name = "David"
age = "30"
print(f"My name is David and I am 30 years old")
...
print(int(input("Введите ваше возраст:")))
if age >= 18:           # Вот тут у меня выходит ошибка, но не могу понять почему и он не выводит результат после возраста
    print(f"{name1}, вы совершеннолетний")
else:
    print(f"{name1}, вы несовершеннолетний")